...
def main_run_backtest():
    ...
    config = {
        ...
        'end_date': '2017-05-31',   # Data de fim da SIMULAÇÃO
        ...
        'num_windows': 75, # Vai de 0 a 27
        'factors_input_prefix': r'fatores/fatores_janela_',
        'returns_input_prefix': r'dad/retornos_diarios_janela_', # <- Prefixo dos retornos
    ...
    df_retornos.to_csv(r'resultados/retornos_diarios.csv')
    print("DataFrame com todos os retornos salvos em resultados")
    ...
    print(f"Arquivo com todos os fatores salvo")
